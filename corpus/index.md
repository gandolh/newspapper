...
- [resume-2026-08-27.md](resume-2026-08-27.md) — a resolved pause point from
  2026-08-27, kept as the record of how it was handled. Historical: the current
  state is [wiki/status.md](wiki/status.md).
...
| [configuration.md](wiki/configuration.md) | Every env var and whether anything actually reads it, the auth variables and their strict-mode behaviour, settings precedence, and one-time setup including Playwright Chromium. |
