...
(Ollama only, no Sharp/canvas/cheerio/Satori/axios, ESM throughout, one post per
day). The *reasoning* behind them lives in [wiki/decisions.md](wiki/decisions.md).
Root CLAUDE.md says what; `decisions.md` says why.
