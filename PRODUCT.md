...
full system is [DESIGN.md](DESIGN.md)._
...
- **The slide theme is not the app.** The rendered 1080² output stays
  ...
  400–900 — and gains two sibling palettes. It appears in exactly one place: on
...
decision knowingly accepts is in [DESIGN.md](DESIGN.md) and the log.
